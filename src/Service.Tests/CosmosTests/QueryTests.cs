...
type Planet @model(name:""Planet"") {
    ...
    age : Int,
            ...
            // cache configuration
            RuntimeConfig configuration = ConfigurationTests.InitMinimalRuntimeConfig(dataSource, graphqlOptions, restRuntimeOptions, new(), entity, entityName, new EntityCacheOptions() { Enabled = true, TtlSeconds = 5 });
